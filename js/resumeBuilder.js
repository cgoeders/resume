	...
	'jobs': [
		{
			...
			'title': 'Course Coordinator and Assistant (Human Genome and Disease, BIO/BIOC 109/209)',
		...
		{
			'employer': 'Stanford University, Department of Biology',
			'title': 'Teaching Assistant (Human Physiology, BIO 112/212)',
			'location': 'Stanford, CA, USA',
		...
		{
			'employer': 'Stanford University, Department of Biology',
			'title': 'Teaching Assistant (Introduction to Brain and Behavior, BIO 20)',
			'location': 'Stanford, CA, USA',
		...
		},
		{
			...
			'title': 'Teaching Staff Member (Emergency Medical Technician (EMT) Training, SURG 111/211)',
			'location': 'Stanford, CA, USA',
			'dates': 'September 2012 - June 2014',
			'description': 'Worked in a team of 10-15 TAs to practically train EMT-B students ' +
...
var projects = {
	'projects': [
		...
		},
		{
			...
			'images': ['images/flower1rsz.jpg']
		},
		{
			'title': 'Piano Performance',
			'dates': '1992 - Present',
			'description': 'Studied with Natalie Dhing (1992-2006), Virginia Garcia (1999-2011), ' +
				'Kumaran Arul (2006-2010), and Maria Ezerova (2010-2011). Made CD recordings and gave ' +
				'numerous solo piano recitals, beginning at age 16 and continuing through college. ' +
				'Held community volunteer solo recitals and performed since age 11 as a recurring guest ' +
				'pianist at live radio- and Internet-cast, large-audience events. Annual medalist in ' +
				'numerous regional and state MTAC piano competitions.',
			'images': ['images/xtpianobdrsz.jpg']
		}
	]
}
...
var bio = {
	...
	'skills':
		[
			'programming', 'teaching', 'piano performance', 'cooking',
...
//Add data to bio section
bio.display = function() {
	//Display name and desired role
...
education.display = function() {
	...
	for (onlineclass in education.onlineCourses) {
		...
		var formattedDates = HTMLonlineDates.replace("%data%", education.onlineCourses[onlineclass].dates);
...
//Modify punctuation of name (internationalize)
function inName(nameold) {
	var spacePos = nameold.indexOf(" ");
	var name1end = nameold.substr(1, spacePos);
	var name1beg = nameold.charAt([0]).toUpperCase();
	var name1new = name1beg + name1end;
	var name2new = nameold.substr(spacePos+1).toUpperCase();
	return name1new + name2new;
}
